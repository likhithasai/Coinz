...
public class CreateAccountSuccessTest {
    ...
    public void createAccountSuccessTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.et_email), withText("tes"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.et_email), withText("test"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.et_email), withText("test"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("testespresso@gmail.com"));

        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.et_email), withText("testespresso@gmail.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.et_password),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("testpasswor"), closeSoftKeyboard());
